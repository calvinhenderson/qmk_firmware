...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    TL_NAV,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFTENTR,
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, MACROP1,
             ...
             KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DQUO, KC_PIPE,
  ...
  [_NAV] = LAYOUT(
    ...
    _______, _______, KC_WH_D, KC_WH_U, _______, _______, _______,
    KC_BTN2, KC_BTN1, QK_LOCK, _______
  )
};
